...
#SBATCH --job-name t_za_001
#SBATCH --time 1-00:00:00
#SBATCH --mem 35GB
#SBATCH --output logs/train_001_%j.log
...
python -u train.py --data_dir=../data/xeno-canto-dataset/Zonotrichiaalbicollis/wav/ --silence_threshold 0.01 --logdir ./logdir/train/za_thresh001
